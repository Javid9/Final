...
namespace JobSearchEndProject.Migrations
{
    ...
    [Migration("20201215150002_AddedJobApplyUser")]
    partial class AddedJobApplyUser
    {
            ...
            modelBuilder.Entity("JobSearchEndProject.Models.Job", b =>
                {
                    ...
                    b.HasOne("JobSearchEndProject.Models.AppUser", "ApplyUser")
                        .WithMany("ApplyUserJob")
