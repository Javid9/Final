...
{
    public partial class AddRelationDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Locationn = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Applies_Cities_CityId",
                        column: x => x.CityId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Applies_Countries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Applies_EducationLevels_EducationLevelId",
                        column: x => x.EducationLevelId,
                        principalTable: "EducationLevels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Applies_Loactions_LocationId",
                        column: x => x.LocationId,
                        principalTable: "Loactions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Applies_States_StateId",
                        column: x => x.StateId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applies_CityId",
                table: "Applies",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_Applies_CountryId",
                table: "Applies",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_Applies_EducationLevelId",
                table: "Applies",
                column: "EducationLevelId");

            migrationBuilder.CreateIndex(
                name: "IX_Applies_LocationId",
                table: "Applies",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_Applies_StateId",
                table: "Applies",
                column: "StateId");
